...
- `ideas/ai-council-call/` — Zoom-style multi-agent meeting prototype using Anthropic-only persona calls, orchestrator guidance, turn/contentious modes, and optional voice output.
